        ...
        <div className="flex flex-col items-center justify-start h-screen">
            ...
            <div className="flex space-x-8 items-center">
                <div className="outline-5 w-75 h-100 rounded-lg shadow-lg pb-4">
                    <Image src="/logo.svg" alt="Milk Tea" width={175} height={150} className="rounded-lg shadow-lg" />
            ...
            <div className="w-full flex justify-end pr-8 mt-auto mb-8">
                <Image src="/vercel.svg" alt="Check Out" width={175} height={150} className="cursor-pointer hover:scale-105 transition-transform" />
            </div>
        </div>
        </div>
    )
